...
class DEAPDataset(BaseDataset):
    ...
    def read_record(
        ...
        **kwargs
        ...
        # 1. Data downsampled to 128Hz
        # 2. EOG (electrooculogram) artifacts removed as described in [1]
        # 3. Applied 4.0-45.0Hz bandpass frequency filter
        # 4. Data averaged to common reference electrode
        # 5. EEG channels reordered to follow the Geneva order mentioned above
        # 6. Data segmented into 60-second trials with 3-second pre-trial baseline removed
