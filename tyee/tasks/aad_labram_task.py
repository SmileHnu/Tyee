...
class AADTask(BaseTask):
    def __init__(self, cfg):
        ...
        self.freeze_backbone = get_nested_field(cfg, 'model.freeze_backbone', False)
        ...
        ch_names = ['FP1', 'FP2', 'F7', 'F3', 'FZ', 'F4', 'F8', 'FC3', 'FCZ', 'FC4', 'T7', 'C3', 'CZ', 'C4', 'T8', 'CP3', 'CPZ', 'CP4', 'P7', 'P3', 'PZ', 'P4', 'P8', 'O1', 'OZ', 'O2', 'M1', 'M2']
    ...
    def build_model(self):
        ...
        # Freeze backbone if specified, after loading weights
